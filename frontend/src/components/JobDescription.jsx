        ...
        <div className='max-w-4xl mx-auto my-14 px-6'>
            ...
            <div className='flex items-center justify-between mb-4'>
                ...
                <Button
                    ...
                    disabled={isApplied}
                    className={`rounded-lg px-6 py-2 text-white font-semibold ${isApplied
            ...
            {/* Section divider */}
            <h2 className='border-b-2 border-gray-200 font-semibold text-lg text-gray-800 pb-3 mb-6'>
                Job Description
            </h2>
            ...
            <div className='bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4'>
                {[
                    ...
                    <div key={label} className='flex items-start gap-4'>
                        <span className='w-40 shrink-0 font-semibold text-gray-900'>{label}:</span>
